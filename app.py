...
:root{--bg:#f5f6f8;--card:#fff;--border:#e2e5ea;--text:#1a1d23;--muted:#6b7280;--blue:#185FA5;--blue-light:#E6F1FB;--blue-dark:#0C447C;--green:#3B6D11;--green-light:#EAF3DE;--red:#A32D2D;--red-light:#FCEBEB;--radius:10px;--radius-sm:6px}
...
function showPage(p){document.querySelectorAll(".page").forEach(e=>e.classList.remove("active"));document.querySelectorAll(".nav-item").forEach(e=>e.classList.remove("active"));document.getElementById("page-"+p).classList.add("active");["overview","register","price","log","settings"].forEach((n,i)=>{if(n===p)document.querySelectorAll(".nav-item")[i].classList.add("active")})}
